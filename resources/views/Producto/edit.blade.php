...
<form method="POST" action="{{ route('producto.update',
$producto->id) }}" role="form">
{{ csrf_field() }}
...
<div class="form-group">
<input type="text"
name="idcat" id="idcat" class="form-control input-sm" value="{{$producto->idcat}}">
</div>
</div>
</div>
...
<div class="form-group">
<input type="text"
name="stock" id="stock" class="form-control input-sm" value="{{$producto->stock}}">
</div>
</div>
